...
class VisualizationAgent:
    ...
    def run(self, state: OrchestrationState, runtime: AgentRuntime) -> AgentEnvelope:
        ...
        config = build_chart_config(state)
        ref = runtime.adapter.register_artifact(
            ...
            metadata={"kind": "chart_config", "chart_type": config["chart_type"], "source_artifact_count": len(parent_ids)},
            preview={
        ...
        return AgentEnvelope(
            ...
            summary=f"{config['chart_type']} chart configuration generated.",
            artifact_refs=[ref],
